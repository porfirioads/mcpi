...
# Instalación de librería nutshell
...
# Información para gráfica de barras de frecuencia de nacimientos
births.dow <- table(births2006.smpl$DOB_WK)
births.dow
barchart(births.dow, ylab = 'Día de la semana', col = 'red')

# Tabla con dos columnas para gráfica de barras
...
# Crea gráfica horizontal con barras agrupadas
barchart(dob.dm.tbl, ylab = "Day of Week")

# Crea gráfica vertical barras separadas
barchart(dob.dm.tbl, horizontal = FALSE,
         groups = FALSE, xlab = "Day of Week")
...
densityplot(don$TGiving[don$TGiving != 0][don$TGiving[don$TGiving != 0] <= 1000])
